...
public:
    ...
    ggml_tensor * t_h_pre_norm  = nullptr; // hidden state before final norm (for MTP)
    ggml_tensor * t_mtp_out     = nullptr; // MTP head output hidden state (for chained drafting)
